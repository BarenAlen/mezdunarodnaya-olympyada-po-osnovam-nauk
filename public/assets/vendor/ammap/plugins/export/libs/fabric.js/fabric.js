                ...
                if (
                    ...
                    klass.prototype[property] = (function (property) {
                        return function () {
                            ...
                            var returnValue = source[property].apply(
                                this,
                                arguments
                            );
...
(function () {
    ...
    if (shouldUseAddListenerRemoveListener) {
        ...
        removeListener = function (element, eventName, handler) {
            ...
            if (listeners[uid] && listeners[uid][eventName]) {
                for (
                    var i = 0, len = listeners[uid][eventName].length;
                    i < len;
                    i++
                ) {
    ...
    function _getPointer(event, pageProp, clientProp) {
        var touchProp =
            event.type === "touchend" ? "changedTouches" : "touches";

        return event[touchProp] && event[touchProp][0]
            ? event[touchProp][0][pageProp] -
                  (event[touchProp][0][pageProp] -
                      event[touchProp][0][clientProp]) || event[clientProp]
            : event[clientProp];
    }
    ...
    if (supportsOpacity) {
        ...
        setOpacity = function (element, value) {
            ...
            if (reOpacity.test(es.filter)) {
                value =
                    value >= 0.9999 ? "" : "alpha(opacity=" + value * 100 + ")";
...
(function () {
    ...
    if (
        ...
        getElementStyle = function (element, attr) {
            var style = fabric.document.defaultView.getComputedStyle(
                element,
                null
            );
    ...
    (function () {
        ...
        function getScript(url, callback) {
            ...
            /** @ignore */
            scriptEl.onload = /** @ignore */ scriptEl.onreadystatechange =
                function (e) {
                    if (loading) {
                        if (
...
(function (global) {
    ...
    function _setStrokeFillOpacity(attributes) {
        for (var attr in colorAttributes) {
            ...
            attributes[attr] = color
                .setAlpha(
                    toFixed(
                        color.getAlpha() * attributes[colorAttributes[attr]],
                        2
                    )
                )
                .toRgba();
    ...
    function parseUseDirectives(doc) {
        ...
        while (nodelist.length && i < nodelist.length) {
            ...
            if (/^svg$/i.test(el2.nodeName)) {
                ...
                for (
                    j = 0, attrs = el2.attributes, l = attrs.length;
                    j < l;
                    j++
                ) {
                    attr = attrs.item(j);
    ...
    function applyViewboxTransform(element) {
        var viewBoxAttr = element.getAttribute("viewBox"),
            ...
            missingViewBox =
                !viewBoxAttr ||
                !reViewBoxTagNames.test(element.tagName) ||
    ...
    fabric.parseSVGDocument = (function () {
        ...
        return function (doc, callback, reviver) {
            ...
            var startTime = new Date(),
                ...
                descendants = fabric.util.toArray(
        ...
        getCSSRules: function (doc) {
            ...
            for (var i = 0, len = styles.length; i < len; i++) {
                ...
                rules.forEach(function (rule) {
                    ...
                    for (
                        var i = 0, len = propertyValuePairs.length;
                        i < len;
                        i++
                    ) {
            ...
            function onComplete(r) {
                ...
                fabric.parseSVGDocument(
                    ...
                    function (results, options) {
                        svgCache.set(url, {
                            objects: fabric.util.array.invoke(
                                results,
                                "toObject"
                            ),
                            options: options,
    ...
    fabric.Color.prototype = /** @lends fabric.Color.prototype */ {
        ...
        overlayWith: function (otherColor) {
            ...
            for (var i = 0; i < 3; i++) {
                result.push(
                    Math.round(
                        source[i] * (1 - otherAlpha) +
                            otherSource[i] * otherAlpha
                    )
                );
            }
...
(function () {
    ...
    function _convertPercentUnitsToValues(object, options, gradientUnits) {
        ...
        for (var prop in options) {
            ...
            if (prop === "x1" || prop === "x2" || prop === "r2") {
                multFactor *=
                    gradientUnits === "objectBoundingBox" ? object.width : 1;
                addFactor =
                ...
                multFactor *=
                    gradientUnits === "objectBoundingBox" ? object.height : 1;
                addFactor =
                    gradientUnits === "objectBoundingBox" ? object.top || 0 : 0;
            }
        ...
        initialize: function (options) {
            ...
            if (options.source) {
                if (typeof options.source === "string") {
                    // function string
                    if (
                        typeof fabric.util.getFunctionBody(options.source) !==
                        "undefined"
                    ) {
        ...
        /** @lends fabric.Shadow.prototype */ {
            ...
            _parseShadow: function (shadow) {
                var shadowStr = shadow.trim(),
                    offsetsAndBlur =
                        fabric.Shadow.reOffsetsAndBlur.exec(shadowStr) || [],
                    color =
    ...
    fabric.StaticCanvas = fabric.util.createClass(
        /** @lends fabric.StaticCanvas.prototype */ {
            ...
            _isRetinaScaling: function () {
                return (
                    fabric.devicePixelRatio !== 1 && this.enableRetinaScaling
                );
            },
             ...
             * canvas.setOverlayImage('http://fabricjs.comassets/jail_cell_bars.png', canvas.renderAll.bind(canvas), {
             ...
             * fabric.Image.fromURL('http://fabricjs.comassets/jail_cell_bars.png', function(img) {
             ...
             * canvas.setBackgroundImage('http://fabricjs.comassets/honey_im_subtle.png', canvas.renderAll.bind(canvas), {
             ...
             * fabric.Image.fromURL('http://fabricjs.comassets/honey_im_subtle.png', function(img) {
             *    img.set({width: canvas.width, height: canvas.height, originX: 'left', originY: 'top'});
             ...
             *   source: 'http://fabricjs.comassets/escheresque_ste.png'
            ...
            zoomToPoint: function (point, value) {
                ...
                var after = fabric.util.transformPoint(
                    point,
            ...
            _chooseObjectsToRender: function () {
                ...
                if (activeGroup && !this.preserveObjectStacking) {
                    for (
                        var i = 0, length = this._objects.length;
                        i < length;
                        i++
                    ) {
            ...
            renderAll: function () {
                ...
                canvasToDrawOn.transform.apply(
                    canvasToDrawOn,
                    this.viewportTransform
                );
            ...
            _toObject: function (instance, methodName, propertiesToInclude) {
                ...
                var originalProperties =
                        this._realizeGroupTransformOnObject(instance),
                ...
                this._unwindGroupTransformOnObject(
                    instance,
                    originalProperties
                );
            ...
            _realizeGroupTransformOnObject: function (instance) {
                ...
                if (
                    instance.group &&
                    instance.group === this.getActiveGroup()
                ) {
            ...
            sendBackwards: function (object, intersecting) {
                ...
                if (object === activeGroup) {
                    ...
                    if (idx !== 0) {
                        ...
                        newIdx = this._findNewLowerIndex(
                            object,
                            idx,
                            intersecting
                        );
            ...
            bringForward: function (object, intersecting) {
                ...
                if (object === activeGroup) {
                    ...
                    if (idx !== this._objects.length - 1) {
                        ...
                        newIdx = this._findNewUpperIndex(
                            object,
                            idx,
                            intersecting
                        );
    ...
    /** @lends fabric.SprayBrush.prototype */ {
        ...
        addSprayChunk: function (pointer) {
            ...
            for (var i = 0; i < this.density; i++) {
                x = fabric.util.getRandomInt(
                    pointer.x - radius,
                    pointer.x + radius
                );
                y = fabric.util.getRandomInt(
                    pointer.y - radius,
                    pointer.y + radius
                );
        ...
        /** @lends fabric.Canvas.prototype */ {
            ...
            _normalizePointer: function (object, pointer) {
                ...
                if (isObjectInGroup) {
                    ...
                    lt = fabric.util.transformPoint(
                        activeGroup.getCenterPoint(),
                        m,
                        false
                    );
                    pointer.x -= lt.x;
            ...
            isTargetTransparent: function (target, x, y) {
                var hasBorders = target.hasBorders,
                    ...
                    shouldTransform =
                        target.group && target.group === this.getActiveGroup();
            ...
            _shouldCenterTransform: function (target) {
                ...
                if (
                    ...
                    centerTransform =
                        this.centeredScaling || target.centeredScaling;
                } else if (t.action === "rotate") {
                    centerTransform =
                        this.centeredRotation || target.centeredRotation;
                }
            ...
            _translateObject: function (x, y) {
                var transform = this._currentTransform,
                    ...
                    moveX =
                        !target.get("lockMovementX") && target.left !== newLeft,
                    moveY =
                        !target.get("lockMovementY") && target.top !== newTop;
            ...
            _scaleObjectEqually: function (
                ...
                transform.newScaleX =
                    (transform.original.scaleX * dist) / lastDist;
                transform.newScaleY =
                    (transform.original.scaleY * dist) / lastDist;
                scaled =
            ...
            findTarget: function (e, skipGroup) {
                ...
                if (
                    !skipGroup &&
                    this._checkTarget(e, activeGroup, this.getPointer(e, true))
                ) {
                    return activeGroup;
                }
            ...
            _searchPossibleTargets: function (e, skipGroup) {
                ...
                while (i--) {
                    if (
                        (!this._objects[i].group || skipGroup) &&
                        this._checkTarget(e, this._objects[i], pointer)
                    ) {
            ...
            deactivateAllWithDispatch: function (e) {
                var activeObject =
                    this.getActiveGroup() || this.getActiveObject();
                if (activeObject) {
    ...
    fabric.util.object.extend(
        ...
        /** @lends fabric.Canvas.prototype */ {
            ...
            _createGroup: function (target) {
                var objects = this.getObjects(),
                    isActiveLower =
                        objects.indexOf(this._activeObject) <
    ...
    /** @lends fabric.StaticCanvas.prototype */ {
        ...
        __toDataURL: function (format, quality, cropping) {
            ...
            var data = fabric.StaticCanvas.supports("toDataURLWithQuality")
                ? (croppedCanvasEl || canvasEl).toDataURL(
                      "image/" + format,
                      quality
                  )
        ...
        /** @lends fabric.Object.prototype */ {
            ...
            transform: function (ctx, fromLeft) {
                ...
                ctx.transform(
                    1,
                    0,
                    Math.tan(degreesToRadians(this.skewX)),
                    1,
                    0,
                    0
                );
                ctx.transform(
                    1,
                    Math.tan(degreesToRadians(this.skewY)),
                    0,
                    1,
                    0,
                    0
            ...
            _removeDefaultValues: function (object) {
                ...
                stateProperties.forEach(function (prop) {
                    ...
                    var isArray =
                        Object.prototype.toString.call(object[prop]) ===
                            "[object Array]" &&
            ...
            setGradient: function (property, options) {
                ...
                gradient.type =
                    options.type ||
                    (options.r1 || options.r2 ? "radial" : "linear");
                gradient.coords = {
                    x1: options.x1,
                    y1: options.y1,
                    x2: options.x2,
                ...
                return this.set(
                    property,
                    fabric.Gradient.forObject(this, gradient)
                );
            },
             ...
             * fabric.util.loadImage('http://fabricjs.comassets/escheresque_ste.png', function(img) {
            ...
            setShadow: function (options) {
                return this.set(
                    "shadow",
                    options ? new fabric.Shadow(options) : null
                );
            },
        ...
        /** @lends fabric.Object.prototype */ {
            ...
            translateToGivenOrigin: function (
                ...
                var x = point.x,
                    y = point.y,
                    offsetX =
                        originXOffset[toOriginX] - originXOffset[fromOriginX],
                    offsetY =
                        originYOffset[toOriginY] - originYOffset[fromOriginY],
                    dim;
                if (offsetX || offsetY) {
            ...
            adjustPosition: function (to) {
                ...
                this.left +=
                    xFull * (originXOffset[to] - originXOffset[this.originX]);
                this.top +=
                    yFull * (originXOffset[to] - originXOffset[this.originX]);
        ...
        /** @lends fabric.Object.prototype */ {
            ...
            intersectsWithRect: function (pointTL, pointBR) {
                var oCoords = getCoords(this.oCoords),
                    intersection =
                        fabric.Intersection.intersectPolygonRectangle(
                            oCoords,
                            pointTL,
                            pointBR
                        );
            ...
            setCoords: function () {
                ...
                var sinTh = Math.sin(theta),
                    ...
                    coords = fabric.util.transformPoint(
                        this.getCenterPoint(),
                        vpt
                    ),
                    tl = new fabric.Point(
            ...
            getSvgTransform: function () {
                ...
                var toFixed = fabric.util.toFixed,
                    ...
                    anglePart =
                        angle !== 0
                            ? " rotate(" +
                              toFixed(angle, NUM_FRACTION_DIGITS) +
                              ")"
                            : "",
                    scalePart =
                    ...
                    skewXPart =
                        skewX !== 0
                            ? " skewX(" +
                              toFixed(skewX, NUM_FRACTION_DIGITS) +
                              ")"
                            : "",
                    skewYPart =
                        skewY !== 0
                            ? " skewY(" +
                              toFixed(skewY, NUM_FRACTION_DIGITS) +
                              ")"
                            : "",
                    ...
                    flipXPart = this.flipX
                        ...
                        : "",
                    addTranslateY =
                        this.type === "path-group" ? this.height : 0,
        ...
        /** @lends fabric.Object.prototype */ {
            ...
            _getTransformedDimensions: function (skewX, skewY) {
                ...
                for (i = 0; i < points.length; i++) {
                    points[i] = fabric.util.transformPoint(
                        points[i],
                        transformMatrix
                    );
                }
    ...
    fabric.Line = fabric.util.createClass(
        ...
        /** @lends fabric.Line.prototype */ {
            ...
            _setWidthHeight: function (options) {
                ...
                this.left =
                    "left" in options ? options.left : this._getLeftToOriginX();

                this.top =
                    "top" in options ? options.top : this._getTopToOriginY();
            },
        ...
        /** @lends fabric.Ellipse.prototype */ {
            ...
            _render: function (ctx, noTransform) {
                ...
                ctx.arc(
                    ...
                    noTransform
                        ? ((this.top + this.ry) * this.rx) / this.ry
                        : 0,
                    this.rx,
                    0,
                    piBy2,
...
(function (global) {
    ...
    fabric.Polyline = fabric.util.createClass(
        ...
        /** @lends fabric.Polyline.prototype */ {
             ...
             */
            initialize: function (points, options) {
                return fabric.Polygon.prototype.initialize.call(
                    this,
                    points,
                    options
                );
            ...
            _render: function (ctx, noTransform) {
                if (
                    !fabric.Polygon.prototype.commonRender.call(
                        this,
                        ctx,
                        noTransform
                    )
    ...
    fabric.Polyline.fromElement = function (element, options) {
        ...
        var points = fabric.parsePointsAttribute(
    ...
    fabric.Path = fabric.util.createClass(
        ...
        /** @lends fabric.Path.prototype */ {
            ...
            _parsePath: function () {
                ...
                for (
                    var i = 0, coordsParsed, len = this.path.length;
                    i < len;
                    i++
                ) {
                    ...
                    if (coordsParsed.length - 1 > commandLength) {
                        for (
                            ...
                            result.push(
                                [command].concat(
                                    coordsParsed.slice(k, k + commandLength)
                                )
                            );
        ...
        /** @lends fabric.PathGroup.prototype */ {
            ...
            complexity: function () {
                return this.paths.reduce(function (total, path) {
                    return (
                        total +
                        (path && path.complexity ? path.complexity() : 0)
                    );
                }, 0);
            },
    ...
    fabric.PathGroup.fromObject = function (object, callback) {
        if (typeof object.paths === "string") {
            fabric.loadSVGFromURL(object.paths, function (elements) {
                ...
                var pathGroup = fabric.util.groupSVGElements(
                    elements,
                    object,
                    pathUrl
                );
...
(function (global) {
            ...
            get: function (prop) {
                if (prop in _lockProperties) {
                    if (this[prop]) {
                        ...
                        for (
                            var i = 0, len = this._objects.length;
                            i < len;
                            i++
                        ) {
    ...
    fabric.Group.fromObject = function (object, callback) {
        fabric.util.enlivenObjects(object.objects, function (enlivenedObjects) {
            ...
            callback &&
                callback(new fabric.Group(enlivenedObjects, object, true));
        });
    };
    ...
    fabric.Image.filters.Pixelate = fabric.util.createClass(
        ...
        /** @lends fabric.Image.filters.Pixelate.prototype */ {
           ...
           */
                        ...
                        for (
                            var _i = i, _ilen = i + this.blocksize;
                            _i < _ilen;
                            _i++
                        ) {
                            for (
        ...
        /** @lends fabric.Image.filters.Resize.prototype */ {
            ...
            applyTo: function (canvasEl, scaleX, scaleY) {
                ...
                if (this.resizeType === "hermite") {
                    imageData = this.hermiteFastResize(
                        canvasEl,
                        oW,
                        oH,
                        dW,
                ...
                if (this.resizeType === "bilinear") {
                    imageData = this.bilinearFiltering(
                        canvasEl,
                        oW,
                        oH,
                        dW,
...
(function (global) {
    ...
    fabric.Text = fabric.util.createClass(
        ...
        /** @lends fabric.Text.prototype */ {
                ...
                function renderLinesAtOffset(offsets) {
                    ...
                    for (i = 0, len = _this._textLines.length; i < len; i++) {
                        (lineWidth = _this._getLineWidth(ctx, i)),
                            (lineLeftOffset =
                                _this._getLineLeftOffset(lineWidth)),
                        ...
                        for (j = 0, oLen = offsets.length; j < oLen; j++) {
                            ctx.fillRect(
                                ...
                                lineHeight +
                                    (_this._fontSizeMult - 1 + offsets[j]) *
                                        _this.fontSize -
                                    halfOfVerticalBox,
                                lineWidth,
                                _this.fontSize / 15
            ...
            _setSVGTextLineJustifed: function (
                i,
                textSpans,
                yPos,
                textLeftOffset
                ...
                textLeftOffset += this._getLineLeftOffset(
                    this._getLineWidth(ctx, i)
                );
                ...
                for (i = 0, len = words.length; i < len; i++) {
                    ...
                    textLeftOffset +=
                        this._getWidthOfWords(ctx, word) + spaceWidth;
                }
            },
        ...
        /** @lends fabric.IText.prototype */ {
            ...
            getSelectionStyles: function (startIndex, endIndex) {
                ...
                var loc = this.get2DCursorLocation(startIndex),
                    style = this._getStyleDeclaration(
                        loc.lineIndex,
                        loc.charIndex
                    );
            ...
            getCurrentCharStyle: function (lineIndex, charIndex) {
                ...
                return {
                    ...
                    textBackgroundColor:
                        (style && style.textBackgroundColor) ||
            ...
            renderCursor: function (boundaries, ctx) {
                var cursorLocation = this.get2DCursorLocation(),
                    ...
                    charHeight = this.getCurrentCharFontSize(
                        lineIndex,
                        charIndex
                    ),
                    leftOffset =
                        lineIndex === 0 && charIndex === 0
                            ? this._getLineLeftOffset(
                                  this._getLineWidth(ctx, lineIndex)
                              )
                            : boundaries.leftOffset;

                ctx.fillStyle = this.getCurrentCharColor(lineIndex, charIndex);
                ctx.globalAlpha = this.__isMousedown
                    ? 1
                    ...
                    if (i === startLine) {
                        for (var j = 0, len = line.length; j < len; j++) {
                            ...
                            if (j < start.charIndex) {
                                lineOffset += this._getWidthOfChar(
                                    ctx,
                                    line[j],
                                    i,
                                    j
            ...
            _renderChars: function (
                ...
                for (
                    ...
                    prevStyle =
                        prevStyle || this.getCurrentCharStyle(lineIndex, i);
            ...
            _renderChar: function (
                ...
                if (decl) {
                    charHeight = this._getHeightOfChar(
                        ctx,
                        _char,
                        lineIndex,
                        i
                ...
                shouldStroke =
                    (shouldStroke || this.stroke) && method === "strokeText";
                ...
                if (textDecoration || textDecoration !== "") {
                    offset =
                        (this._fontSizeFraction * lineHeight) / this.lineHeight;
            ...
            _hasStyleChanged: function (prevStyle, thisStyle) {
                return (
                    ...
                    prevStyle.textBackgroundColor !==
                        thisStyle.textBackgroundColor ||
            ...
            _applyCharStylesGetWidth: function (
                ...
                if (typeof styleDeclaration.shadow === "string") {
                    styleDeclaration.shadow = new fabric.Shadow(
                        styleDeclaration.shadow
                    );
                }
                ...
                ctx.lineWidth =
                    styleDeclaration.strokeWidth || this.strokeWidth;
            ...
            _getWidthOfChar: function (ctx, _char, lineIndex, charIndex) {
                ...
                var styleDeclaration = this._getStyleDeclaration(
                    lineIndex,
                    charIndex,
                    true
                );
            ...
            _getWidthOfSpace: function (ctx, lineIndex) {
                ...
                var line = this._textLines[lineIndex],
                    ...
                    numSpaces =
                        line.length -
                        line.replace(this._reSpacesAndTabs, "").length,
                    width = Math.max(
                        widthDiff / numSpaces,
        ...
        /** @lends fabric.IText.prototype */ {
            ...
            _animateCursor: function (
                ...
                obj.animate("_currentCursorOpacity", targetOpacity, {
                    ...
                    onChange: function () {
                        if (obj.canvas) {
                            obj.canvas.clearContext(
                                obj.canvas.contextTop || obj.ctx
                            );
            ...
            initDelayedCursor: function (restart) {
                ...
                if (this.canvas) {
                    this.canvas.clearContext(
                        this.canvas.contextTop || this.ctx
                    );
            ...
            selectLine: function (selectionStart) {
                var newSelectionStart =
                        this.findLineBoundaryLeft(selectionStart),
                    newSelectionEnd =
                        this.findLineBoundaryRight(selectionStart);
            ...
            initMouseMoveHandler: function () {
                ...
                this.canvas.on("mouse:move", function (options) {
                    ...
                    var newSelectionStart = _this.getSelectionStartFromPointer(
                        options.e
                    );
                    if (
                        newSelectionStart >= _this.__selectionStartOnMouseDown
                    ) {
                        _this.setSelectionStart(
                            _this.__selectionStartOnMouseDown
                        );
                        _this.setSelectionEnd(newSelectionStart);
                    } else {
                        _this.setSelectionStart(newSelectionStart);
                        _this.setSelectionEnd(
                            _this.__selectionStartOnMouseDown
                        );
                    }
                });
            ...
            insertNewlineStyleObject: function (
                ...
                if (
                    ...
                    this.styles[lineIndex][charIndex - 1]
                ) {
                ...
                // after cursor onto the next line, from the beginning
                    ...
                    for (var index in this.styles[lineIndex]) {
                        if (parseInt(index, 10) >= charIndex) {
                            newLineStyles[parseInt(index, 10) - charIndex] =
            ...
            shiftLineStyles: function (lineIndex, offset) {
                ...
                for (var line in this.styles) {
                    ...
                    if (numericLine > lineIndex) {
                        this.styles[numericLine + offset] =
...
fabric.util.object.extend(
    ...
    /** @lends fabric.IText.prototype */ {
        ...
        initHiddenTextarea: function (e) {
            ...
            if (this.canvas) {
                this.canvas.lowerCanvasEl.parentNode.appendChild(
                    this.hiddenTextarea
                );
            } else {
        ...
        onInput: function (e) {
            ...
            if (newTextLength > textLength) {
                ...
                start =
                    this._selectionDirection === "left" ? offsetEnd : offset;
                diff = newTextLength - textLength;
                charsToInsert = this.hiddenTextarea.value.slice(
                    start,
                    start + diff
                );
            } else {
        ...
        getDownCursorOffset: function (e, isRight) {
            var selectionProp = isRight
                ...
                lineLeftOffset,
                lineIndex = cursorLocation.lineIndex,
                textOnSameLineBeforeCursor = this._textLines[lineIndex].slice(
                    0,
                    cursorLocation.charIndex
                ),
                textOnSameLineAfterCursor = this._textLines[lineIndex].slice(
                    cursorLocation.charIndex
                ),
            ...
            var widthOfSameLineBeforeCursor = this._getLineWidth(
                this.ctx,
                lineIndex
            );
            lineLeftOffset = this._getLineLeftOffset(
            ...
            for (
                var i = 0, len = textOnSameLineBeforeCursor.length;
                i < len;
                i++
            ) {
        ...
        _getIndexOnNextLine: function (
            ...
            for (var j = 0, jlen = textOnNextLine.length; j < jlen; j++) {
                var _char = textOnNextLine[j],
                    widthOfChar = this._getWidthOfChar(
                        this.ctx,
                        _char,
                        lineIndex,
                        j
                ...
                if (
                    widthOfCharsOnNextLine > widthOfCharsOnSameLineBeforeCursor
                ) {
                    foundMatch = true;
        ...
        getUpCursorOffset: function (e, isRight) {
            ...
            var textOnSameLineBeforeCursor = this._textLines[lineIndex].slice(
                    0,
                    cursorLocation.charIndex
                ),
                textOnPreviousLine = this._textLines[lineIndex - 1] || "",
                _char,
                widthOfSameLineBeforeCursor = this._getLineWidth(
                    this.ctx,
                    cursorLocation.lineIndex
                ),
                lineLeftOffset = this._getLineLeftOffset(
        ...
        _move: function (e, prop, direction) {
            ...
            if (e.altKey) {
                this[propMethod](
                    this["findWordBoundary" + direction](this[prop])
                );
            } else if (e.metaKey || e.keyCode === 35 || e.keyCode === 36) {
                this[propMethod](
                    this["findLineBoundary" + direction](this[prop])
                );
            } else {
        ...
        _removeCharsNearCursor: function (e) {
            ...
            if (e.metaKey) {
                ...
                var leftLineBoundary = this.findLineBoundaryLeft(
                    this.selectionStart
                );
                ...
                var leftWordBoundary = this.findWordBoundaryLeft(
                    this.selectionStart
                );
        ...
        /** @lends fabric.IText.prototype */ {
            ...
            _setSVGTextLineChars: function (
                ...
                for (var i = 0, len = chars.length; i < len; i++) {
                    var styleDecl =
                        this._getStyleDeclaration(lineIndex, i) || {};
            ...
            _createTextCharSpan: function (
                ...
                return [
                    ...
                    styleDecl.fontFamily
                        ? 'font-family="' +
                          styleDecl.fontFamily.replace(/"/g, "'") +
                          '" '
                        : "",
                    styleDecl.fontSize
                        ? 'font-size="' + styleDecl.fontSize + '" '
                        : "",
                    styleDecl.fontStyle
            ...
            if (key === "scaleX") {
                ...
                this.set(
                    ...
                    (this.get("width") * value) /
                        (typeof this.__oldScaleX === "undefined"
                            ? 1
                            : this.__oldScaleX)
                );
...
(function () {
    ...
    fabric.Canvas.prototype._setObjectScale = function (
        ...
        if (t instanceof fabric.Textbox) {
            var w =
                t.width *
                (localMouse.x / transform.scaleX / (t.width + t.strokeWidth));
            if (w >= t.getMinWidth()) {
                t.set("width", w);
                return true;
            }
        ...
        /** @lends fabric.IText.prototype */ {
            ...
            _getTextOnPreviousLine: function (lIndex) {
                ...
                while (
                    ...
                    this._styleMap[lIndex - 2].line ===
                        this._styleMap[lIndex - 1].line
                ) {
                    textOnPreviousLine =
                        this._textLines[lIndex - 2] + textOnPreviousLine;
